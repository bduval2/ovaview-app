...
There are other systems that attempt to respect user privacy, most notably Clue period tracking app. Unfortunately, they still adhere to malpractices and mistakes, rearing a rather ugly head [^5]. Some of these issues include:
...
Following the 7 Foundational Principles published by privacybydesign [^4].
...
[^5]: https://foundation.mozilla.org/en/privacynotincluded/clue-period-cycle-tracker/
