...
Our app, in essence, is a simple calendar-style tracker. We offer a mutable calendar UI to each user which they can use to log their periods by assigning a mood, a set of symptoms and a note with any thoughts/feelings they had for that day. There exists one additional feature that users are given opportunities to opt-in to, where in the logs they submit are anonymously processed by our proprietary prediction algorithm, which allows us to provide them with a forecast of future menstrual activity.
